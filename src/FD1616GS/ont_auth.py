...
def get_onu_info(tn, PonID, OnuID, SN):
    ...
    if SN in get_ont_info:
        ...
        CATV_Rx_optical_power = re.findall('CATV Rx optical power\(dBm\)     : (.*)', get_ont_optical_info)
...
if __name__ == '__main__':
    ...
    add_service_port(tn, Gpon_PonID, Gpon_OnuID, Gemport_ID, Vlan_list=Vlan_list)