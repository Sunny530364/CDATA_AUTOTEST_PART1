...
#         assert gemport_vlan_pri(tn,ont_lineprofile_id=Ont_Lineprofile_ID)
...
def test_gemport_port(gemport_port_suit):
    ...
    with allure.step("步骤5:打流测试"):
        ...
        up_stream_header = (
            'ethernetII_1.sourceMacAdd=00:00:00:22:22:21 vlan_1.id=2000  ethernetII_1.destMacAdd=00:00:00:11:11:11 ipv4_1.source=192.168.1.21 ipv4_1.destination=192.168.1.11', )
        result_stats = unicast_test(port_location=port_location, down_stream_header=down_stream_header,
                               up_stream_header=up_stream_header, num=1, dataclassname=StreamBlockStats,
                               duration=duration)
...
if __name__ == '__main__':
    pytest.main(['-v',"-s",'-x' , 'test_onu_gemport.py::test_gemport_vlan_pri'] )